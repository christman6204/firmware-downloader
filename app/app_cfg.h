...
/* ==================== SD 卡 ==================== */
/* ==================== SD 卡固件文件 ==================== */
/* 命名规则: IL_800_XXX_XXX.BIN  (XXX=3位数字, 主版本_子版本)
   多个 BIN 文件时自动选版本号最高的。例:
     IL_800_001_002.BIN = 主版本 1, 子版本 2
     IL_800_002_000.BIN = 主版本 2, 子版本 0  <- 选这个(主版本更高) */
#define  APP_SD_BIN_PREFIX            "IL_800_"     /* 文件名前缀 */
#define  APP_SD_BIN_EXT               ".BIN"        /* 文件名后缀 */
